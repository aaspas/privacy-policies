...
Each application is operated for an individual shop owner but is owned, maintained, and distributed by Aaspas.
...
- The application is licensed to shop owners under specific terms.
- Shop owners do not own the application or its source code.
- Shop owners are granted limited rights to use the platform under Aaspas terms.
...
However, shop owners may access an administrative panel within the app using secure credentials.

Admin login access is restricted solely to the respective shop owner.
...
Aaspas does not verify ownership of trademarks or intellectual property uploaded by shop owners.

The shop owner is solely responsible for ensuring that their content does not violate copyright, trademark, or applicable laws.
